...
* to the other platform.
*/
extern u16 ch1,ch2,ch3,ch4,s1,s2;
u8 re_flag;
void DMA1_Stream5_IRQHandler(void)
{
	if(DMA_GetITStatus(DMA1_Stream5, DMA_IT_TCIF5))
	{
		...
		ch2=RC_Ctl.rc.ch2;if(ch1>1684) ch2=1684;else if(ch2<364) ch2=364; //_NOP();_NOP();
		ch4=RC_Ctl.rc.ch4;if(ch4>1684) ch4=1684;else if(ch4<364) ch4=364; //_NOP();_NOP();
