...
/*--------------------LED-----------------------------*/
#define Open_LED_GPIO_CLK							RCC_AHB1Periph_GPIOD
#define Open_LED_GPIO								GPIOD

#define Open_GPIO_Pin_LED1							GPIO_Pin_12
#define Open_GPIO_Pin_LED2							GPIO_Pin_13
#define Open_GPIO_Pin_LED3							GPIO_Pin_14
#define Open_GPIO_Pin_LED4							GPIO_Pin_15

/*--------------------JOYSTICK-----------------------------*/
//A(PB15)  B(PD9)  C(PD11)  D(PD13)  PRESS(PD15)
#define  Open_JOYSTICK_A_CLK						RCC_AHB1Periph_GPIOA 
#define  Open_JOYSTICK_A_PORT						GPIOA
#define Open_GPIO_Pin_A              				GPIO_Pin_4

#define  Open_JOYSTICK_B_CLK						RCC_AHB1Periph_GPIOA
#define  Open_JOYSTICK_B_PORT						GPIOA
#define Open_GPIO_Pin_B              				GPIO_Pin_6

#define  Open_JOYSTICK_C_CLK						RCC_AHB1Periph_GPIOB
#define  Open_JOYSTICK_C_PORT						GPIOB
#define Open_GPIO_Pin_C              				GPIO_Pin_15


#define  Open_JOYSTICK_D_CLK						RCC_AHB1Periph_GPIOC
#define  Open_JOYSTICK_D_PORT						GPIOC  
#define Open_GPIO_Pin_D              				GPIO_Pin_6

#define  Open_JOYSTICK_PRESS_CLK						RCC_AHB1Periph_GPIOC
#define  Open_JOYSTICK_PRESS_PORT						GPIOC
#define Open_GPIO_Pin_PRESS              				GPIO_Pin_7



#define Open_USER_CLK								RCC_AHB1Periph_GPIOB    
#define Open_USER_PORT								GPIOB	
...
/*----------------------------------------------------*/
	...
	#define Open_USARTx_TX_PIN                 	GPIO_Pin_2
	#define Open_USARTx_TX_GPIO_PORT           	GPIOA
	#define Open_USARTx_TX_GPIO_CLK            	RCC_AHB1Periph_GPIOA
	#define Open_USARTx_TX_SOURCE              	GPIO_PinSource2
	#define Open_USARTx_TX_AF                  	GPIO_AF_USART2
	
	
	#define Open_USARTx_RX_PIN                 	GPIO_Pin_3
	#define Open_USARTx_RX_GPIO_PORT           	GPIOA
	#define Open_USARTx_RX_GPIO_CLK            	RCC_AHB1Periph_GPIOA
	#define Open_USARTx_RX_SOURCE              	GPIO_PinSource3
...
#define I2Cx_SLAVE_ADDRESS7      0x30
  ...
  #define Open_CAN_RX_PIN                 GPIO_Pin_0
  #define Open_CAN_TX_PIN                 GPIO_Pin_1
  #define Open_CAN_GPIO_PORT              GPIOD
  #define Open_CAN_GPIO_CLK               RCC_AHB1Periph_GPIOD
  #define Open_CAN_AF_PORT                GPIO_AF_CAN1
  #define Open_CAN_RX_SOURCE              GPIO_PinSource0
  #define Open_CAN_TX_SOURCE              GPIO_PinSource1
#endif       
#ifdef OpenCAN2
