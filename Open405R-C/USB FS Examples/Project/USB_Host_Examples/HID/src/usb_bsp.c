...
#define HOST_OVRCURR_PORT_SOURCE           GPIO_PortSourceGPIOC
#define HOST_OVRCURR_PIN_SOURCE            GPIO_PinSource12
#define HOST_OVRCURR_PORT_RCC              RCC_AHB1Periph_GPIOC
...
// #define HOST_SOF_OUTPUT_RCC                RCC_APB2Periph_GPIOC
// #define HOST_SOF_PORT                      GPIOC
// #define HOST_SOF_SIGNAL                    GPIO_Pin_1
